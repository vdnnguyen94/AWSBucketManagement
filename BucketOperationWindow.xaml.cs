...
{
    public partial class BucketOperationsWindow : Window
    {
        private readonly BucketOps _bucketOps;

        public BucketOperationsWindow()
        {
            InitializeComponent();
            ...
            this.Closed += BucketOperationsWindow_Closed;
        }

        private void BucketOperationsWindow_Closed(object? sender, EventArgs e)
        {
            // Application.Current.MainWindow is the first window that was opened.
        ...
        private async void DeleteBucket_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (objects.Any()) // check bucket empty or not
                {
                    // 3. ask users if it's not empty
                    ...
                    {
                        // If confirmed, empty the bucket first, then delete
                ...
                {
                    //If empty, delete it straight away.
